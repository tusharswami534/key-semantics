...
export const KEY_FAQ_HEADING_LIST = [
...
export const KEY_FAQ_LIST =[
    {
        ...
        'imageOne' : './assets/images/png/key-faq-1.png',
        'imageTwo' : './assets/images/png/key-faq-2.png',
...
export const KEY_SEMANTICS_CARD_LIST =[
    {
        lottie : Server,
